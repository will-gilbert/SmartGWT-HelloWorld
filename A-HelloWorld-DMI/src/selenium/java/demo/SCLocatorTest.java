...
public class SCLocatorTest {
    ...
    */
    ...
    public static void instanceWebDriver() {
        ...
        // Get the test URL; 
        String baseUrl = System.getProperty("selenium.test.baseUrl");
        assertNotNull(baseUrl);

        String getUrl = System.getProperty("selenium.test.getUrl");
        assertNotNull(getUrl);

        urlToTest = baseUrl + getUrl;
    ...
    public void locationById() {
        WebElement scButton = driver.findElement(ByScLocator.scLocator("HelloWorld.button"));
    ...
    public void explictWait() throws Exception {
        ...
        WebElement helloWorldButton = explictWait(driver, ByScLocator.scLocator("HelloWorld.button"));
    ...
    public void fluentWait() throws Exception {
        ...
        WebElement helloWorldButton = fluentWait(driver, ByScLocator.scLocator("HelloWorld.button"));
        assertNotNull(helloWorldButton);
